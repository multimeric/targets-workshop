...
tar_option_set(
  controller = crew_controller_slurm(
    workers = 3,
    script_lines = "module load R/4.2.3",
...
You can find the `SBATCH` flags to use for this purpose at WEHI [**here**](https://wehieduau.sharepoint.com/sites/rc2/SitePages/GPUs-on-Milton.aspx#using-gpus).
:::
::: solution
```{R}
